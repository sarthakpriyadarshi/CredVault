  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (result?.error) {
        ...
        let errorMessage =
          "Account created successfully! Please verify your email address before signing in. Check your inbox for the verification link. If you don't see it, check your spam folder.";

        // Check for email verification error (most common case after signup)
        if (
          errorStr.includes("EMAIL_NOT_VERIFIED") ||
          errorStr.includes("verify your email") ||
          (errorStr.includes("Email") && errorStr.includes("verified"))
        ) {
          errorMessage =
            "Account created successfully! Please verify your email address before signing in. Check your inbox for the verification link. If you don't see it, check your spam folder.";
          ...
          if (
            ...
            errorStr.includes("CallbackRouteError")
          ) {
            errorMessage =
              "Account created successfully! Please verify your email address before signing in. Check your inbox for the verification link. If you don't see it, check your spam folder.";
            setShowResendButton(true);
            ...
            >
              ...
              <div className="text-center mb-8 mt-8 md:mt-0">
                ...
                <p className="text-zinc-400">
                  Join CredVault to receive your credentials
                </p>
              </div>
                    ...
                    >
                      <div className="relative mt-0.5">
                        <input
                          ...
                          required
                        />
                        <div className="flex h-5 w-5 items-center justify-center rounded-md border-2 transition-all duration-200 border-zinc-700 bg-zinc-800/50 peer-checked:border-primary peer-checked:bg-primary peer-focus-visible:ring-2 peer-focus-visible:ring-primary/50 peer-focus-visible:ring-offset-2 peer-focus-visible:ring-offset-transparent pointer-events-none">
                          <svg
