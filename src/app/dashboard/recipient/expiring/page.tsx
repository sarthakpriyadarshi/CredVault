  ...
  const loadData = async () => {
    ...
    try {
      ...
      const credentialsRes = await fetch(
        "/api/v1/recipient/credentials?filter=expiring&limit=100",
        fetchOptions
      );
            ...
            <div className="space-y-8">
              ...
              <Card className="p-6 border border-border/50 bg-card/50 backdrop-blur">
                ...
                {loading ? (
                  ...
                  <div className="text-muted-foreground text-sm">
                    No credentials expiring soon. All your credentials are
                    valid!
                  </div>
                ) : (
                        ...
                        >
                          ...
                          <div className="flex gap-2 flex-wrap md:flex-nowrap">
                            ...
                            <Button
                              ...
                              className="gap-2 bg-transparent"
                              onClick={() =>
                                handleShare(credential.id, credential.title)
                              }
                            >
                            ...
                            credential.badgeUrl ? (
                              <Button
                                size="sm"
                                className="bg-linear-to-b from-primary to-primary/80 text-primary-foreground shadow-[0px_2px_0px_0px_rgba(255,255,255,0.3)_inset] gap-2"
      ...
      <Dialog open={shareDialogOpen} onOpenChange={setShareDialogOpen}>
        <DialogContent className="sm:max-w-md">
          <DialogHeader>
            ...
            <DialogDescription>
              Share this credential verification link with others
            </DialogDescription>
          </DialogHeader>
          <div className="flex flex-col gap-3 py-4">
            ...
            <button
              ...
              className="flex items-center justify-center gap-2 p-3 rounded-lg border hover:bg-accent transition-colors font-medium"
            >
              <svg
                className="w-5 h-5"
                fill="none"
