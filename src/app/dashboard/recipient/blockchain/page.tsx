...
export default function BlockchainCredentialsPage() {
  ...
  const loadData = async () => {
    ...
    try {
      ...
      const credentialsRes = await fetch(
        "/api/v1/recipient/credentials?filter=blockchain&limit=100",
        fetchOptions
      );
  ...
  const handleSharePlatform = (platform: string) => {
    ...
    const urls: { [key: string]: string } = {
      ...
      whatsapp: `https://wa.me/?text=${encodedText}%20%0D%0A${shareUrlEncoded}`,
    };
            ...
            <div className="space-y-8">
              <div className="space-y-2">
                ...
                <p className="text-muted-foreground">
                  View your credentials verified on the blockchain
                </p>
              </div>
              ...
              <Card className="p-6 border border-border/50 bg-card/50 backdrop-blur">
                ...
                {loading ? (
                  ...
                  <div className="text-muted-foreground text-sm">
                    No blockchain-verified credentials yet. Blockchain-verified
