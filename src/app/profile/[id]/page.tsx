  ...
  const loadProfile = async () => {
    ...
    try {
      const res = await fetch(
        `/api/v1/profile/${encodeURIComponent(idOrEmail)}`
      );
                ...
                <div className="flex items-center justify-between">
                  <div className="space-y-2">
                    ...
                    <p className="text-2xl font-bold text-foreground">
                      {totalCredentials > 0
                        ? Math.round(
                            (blockchainVerified / totalCredentials) * 100
                          )
                        : 0}
                      %
                    </p>
              ...
              {credentials.length === 0 ? (
                  ...
                  <div className="flex flex-col items-center gap-4">
                    ...
                    <div className="space-y-2">
                      ...
                      <p className="text-muted-foreground max-w-md">
                        This profile doesn&apos;t have any credentials to
                        display yet. Check back later!
                      </p>
                    </div>
                  </div>
                </Card>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  {credentials.map((credential) => (
                    <Card
                      key={credential.id}
                      className="p-5 border border-border/50 bg-card/50 backdrop-blur hover:border-border/80 transition-colors"
                    >
                      <div className="space-y-4">
                        <div className="space-y-2">
