...
export default function Features() {
  ...
  const [baseColor, setBaseColor] = useState<[number, number, number]>([
    0.863, 0.188, 0.188,
  ]); // Primary color in RGB normalized (pinkish-red)
      ...
      >
        ...
        >
          <div className="cursor-none">
            <div className="grid grid-cols-12 gap-4 justify-center px-4 md:px-0">
              {/* Cli */}
              <motion.div
                ...
                whileHover={{
                  scale: 1.02,
                  borderColor: "rgba(220, 48, 77, 0.6)",
                  boxShadow: "0 0 30px rgba(220, 48, 77, 0.3)",
                  transition: { duration: 0.3, ease: "easeOut" },
                }}
              >
                <div className="flex flex-col gap-4 mb-6">
                  <h3 className="text-2xl leading-none font-semibold tracking-tight text-primary group-hover:text-primary">
                    Template Creation & Management
                  </h3>
                  <div className="text-md text-muted-foreground flex flex-col gap-2 text-sm">
                    <p className="max-w-[460px]">
                      Create custom certificate and badge templates with
                      drag-and-drop placeholders. Define field types,
                      coordinates, and organize templates by categories like
                      Security, General, and more.
                    </p>
                  </div>
                </div>
                  ...
                  >
                    ...
                    <div className="absolute inset-0">
                      <Image
                        ...
                        style={{
                          filter:
                            "hue-rotate(-30deg) saturate(1.2) brightness(0.9)",
                        }}
                        loading="lazy"
                        quality={85}
                      />
                      ...
                      <div
                        ...
                        style={{
                          background:
                            "linear-gradient(135deg, rgba(220, 48, 77, 0.3) 0%, rgba(220, 48, 77, 0.1) 100%)",
                      ...
                      <div
                        ...
                        style={{
                          background:
                            "radial-gradient(circle at center, rgba(220, 48, 77, 0.15) 0%, transparent 70%)",
                    ...
                    <motion.div
                      className="absolute top-1/2 left-1/2 w-16 h-16 rounded-full blur-[74px] opacity-80 transform -translate-x-1/2 -translate-y-1/2"
                      style={{ backgroundColor: "rgb(255, 255, 255)" }}
                      initial={{ scale: 1, opacity: 0 }}
                      animate={
                        isCliHovering
                          ? { scale: [1, 1.342, 1, 1.342], opacity: 0.8 }
                          : { scale: 1, opacity: 0 }
                      }
                      transition={{
                    ...
                    <div className="absolute inset-0 flex items-center justify-center">
                      <div className="flex items-center gap-8">
                        ...
                        <div className="flex flex-col gap-3">
                          {["Certificate", "Badge", "Template"].map(
                            (item, index) => (
                              <motion.div
                                key={`left-${index}`}
                        ...
                        {/* Center Logo */}
                        <motion.div
                          className="w-16 h-16 border border-gray-300 rounded-lg overflow-hidden shadow-lg bg-white flex items-center justify-center -ml-2"
              ...
              >
                <div className="flex flex-col gap-4 mb-6">
                  ...
                  <div className="text-md text-muted-foreground flex flex-col gap-2 text-sm">
                    <p className="max-w-[460px]">
                      Issue credentials at scale with CSV bulk upload. Map
                      columns to template fields and send certificates and
                      badges to recipients instantly. Email ID is mandatory for
                      delivery.
                    </p>
                  </div>
                </div>
              ...
              >
                <div className="flex flex-col gap-4 mb-6">
                  ...
                  <div className="text-md text-muted-foreground flex flex-col gap-2 text-sm">
                    <p className="max-w-[460px]">
                      Choose blockchain or traditional verification. Credentials
                      can be verified through our database or blockchain
                      networks for immutable proof of authenticity.
                    </p>
                  </div>
                </div>
              ...
              <motion.div
                ...
                whileHover={{
                  rotateY: 5,
                  rotateX: 2,
                  boxShadow: "0 20px 40px rgba(220, 48, 77, 0.3)",
                  borderColor: "rgba(220, 48, 77, 0.6)",
                  transition: { duration: 0.3, ease: "easeOut" },
                }}
              >
                <div className="flex flex-col gap-4 mb-6">
                  ...
                  <div className="text-md text-muted-foreground flex flex-col gap-2 text-sm">
                    <p className="max-w-[460px]">
                      Recipients can view all credentials, filter by blockchain
                      status, check expiration dates, and verify credentials
                      with a single click. Full verification page with
